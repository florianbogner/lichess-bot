...
def move2ix(move, color):
    if not hasattr(move2ix, 'move_dict'):
        move2ix.move_dict = {
            'white': {},
            'black': {}
        }
        for ix, m in enumerate(policy_index):
            move2ix.move_dict['white'][m] = ix
            move2ix.move_dict['black'][m[:4].translate(str.maketrans("abcdefgh12345678", "hgfedcba87654321")) + m[4:]] = ix
    
    return move2ix.move_dict[color][move]